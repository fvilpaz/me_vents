...
// ==========================================================================
// GLOSARIO Y DICCIONARIO OPERATIVO
// ==========================================================================
const glossaryState = {
  terms: [],
  categories: [],
...
async function loadGlossaryData() {
  try {
    ...
    console.log('Cargando glosario desde caché local...');
  }
}
...
function setupGlossaryListeners() {
  ...
  // Filtros de categoría del glosario
  ...
  // Toggle formulario nuevo término
  ...
  // Envío del formulario de nuevo término
  if (newTermForm) {
